...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { zh: '跨应用复制按选中内容导出波形和文字，支持适合聊天软件的图片内容和适合矢量目标的 SVG 内容，不包含网格、坐标轴、图例或 Cursor。', en: 'Cross-application copy exports only selected waveforms and text, providing image content for chat applications and SVG content for vector-capable targets, without grid, axes, legend, or Cursor.' },
