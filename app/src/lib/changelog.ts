...
export const CHANGELOG_ENTRIES: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      { zh: '跨应用复制按选中内容导出波形和文字：复制到 PowerPoint 后的波形可直接编辑，复制到 Visio 后目前暂不支持编辑；不包含网格、坐标轴、图例或 Cursor。', en: 'Cross-application copy exports only selected waveforms and text: pasted waveforms are directly editable in PowerPoint, while editing is not currently supported in Visio. Grid, axes, legend, and Cursor are excluded.' },
