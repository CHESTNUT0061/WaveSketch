...
const S = {
  ...
  toolText: { zh: '文字', en: 'Text' },
  defaultAnnotationText: { zh: '文字标注', en: 'Text annotation' },
  ...
  tipText: { zh: '点击画布创建文字；双击编辑，Shift+Enter 换行，Enter 完成', en: 'Click the canvas to add text; double-click to edit, Shift+Enter for a new line, Enter to finish' },
  ...
  // Text annotations
  annotationSettings: { zh: '文字设置', en: 'Text settings' },
  annotationText: { zh: '标注内容', en: 'Annotation text' },
  annotationFont: { zh: '字体', en: 'Font' },
  annotationSize: { zh: '字号', en: 'Size' },
  annotationColor: { zh: '文字颜色', en: 'Text color' },
  annotationTargetSelection: { zh: '应用到：选中文字', en: 'Apply to: selected text' },
  annotationTargetBox: { zh: '应用到：整个文字框', en: 'Apply to: entire text box' },
  annotationSuperscript: { zh: '上标', en: 'Superscript' },
  annotationSubscript: { zh: '下标', en: 'Subscript' },
  annotationClearFormat: { zh: '清除局部格式', en: 'Clear local formatting' },
  annotationWaveformColors: { zh: '使用波形颜色', en: 'Use waveform color' },
  useWaveformColor: { zh: '使用波形颜色', en: 'Use waveform color' },
  annotationAlign: { zh: '对齐', en: 'Alignment' },
  alignLeft: { zh: '左对齐', en: 'Left' },
  alignCenter: { zh: '居中', en: 'Center' },
  alignRight: { zh: '右对齐', en: 'Right' },
  deleteAnnotation: { zh: '删除文字标注', en: 'Delete annotation' },
  ...
  copySystemUnavailable: { zh: '当前浏览器不支持跨应用 SVG/PNG 剪贴板。', en: 'This browser does not support cross-app SVG/PNG clipboard.' },
