...
- **Waveform generator** — square, ramp, sine, triangle, trapezoid, rectified sine, damped ringing; with duty cycle where applicable, multi-phase interleaving, and DC offset control
...
- **波形生成器** — 方波、斜坡、正弦、三角、梯形、整流正弦、阻尼振荡（振铃），支持适用波形的占空比、多相错相和直流偏置
